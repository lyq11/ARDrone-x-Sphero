...
public class JoystickFactory 
{
	...
	public static JoystickBase createSpheroJoystick(Context context, boolean absolute, JoystickListener acceleroListener) {
		SpheroJoystick joy = new SpheroJoystick(context, Align.NO_ALIGN, absolute);
		joy.setOnAnalogueChangedListener(acceleroListener);
		
		return joy;
	}

	public static JoystickBase createSpheroAltJoystick(Context context, boolean absolute, JoystickListener acceleroListener) {
		SpheroAltJoystick joy = new SpheroAltJoystick(context, Align.NO_ALIGN, absolute);
		joy.setOnAnalogueChangedListener(acceleroListener);
		
		return joy;
	}

	public static JoystickBase createSpheroDisconnectedJoystick(Context context, boolean absolute, JoystickListener acceleroListener) {
		SpheroDisconnectedJoystick joy = new SpheroDisconnectedJoystick(context, Align.NO_ALIGN, absolute);
		joy.setOnAnalogueChangedListener(acceleroListener);
