        ...
        OnClickListener
{
    ...
    private CheckBox toggleSpheroMode;
            ...
            EDroneVersion droneVersion, boolean magnetoAvailable)
    {
        ...
        toggleSpheroMode = (CheckBox) settingsViews.get(devicePageIdx).findViewById(R.id.toggleSpheroEnabled);
        ...
        toggleButtons = new CheckBox[] {
                toggleJoypadMode, toggleSpheroMode, toggleAbsoluteControl, toggleLeftHanded,
    ...
    public void setSpheroChecked(boolean value) {
    	if ( toggleSpheroMode != null ) {
    		toggleSpheroMode.setChecked(value);
    	}
    }
