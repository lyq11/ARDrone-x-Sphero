			   ...
			   OnGestureListener
{
	...
	private static final int SPHERO_COMBINED_YAW_ON = 28;
	private static final int SPHERO_COMBINED_YAW_OFF = 29;
...
//	private Text txtSphPitch;
//	private Text txtSphRoll;
//	private Text txtDronePitch;
//	private Text txtDroneRoll;
//	private Text txtSph2Pitch;
//	private Text txtSph2Roll;
//	private Text txtDroneGaz;
//	private Text txtDroneYaw;
	
	private Button btnCombinedYawOn;
	private Button btnCombinedYawOff;
...
//			root.addView(canvasView, 0);
		...
		btnCombinedYawOn = new Button(res, R.drawable.btn_sphero1, R.drawable.btn_sphero1, Align.BOTTOM_RIGHT);
		btnCombinedYawOn.setMargin(0, res.getDimensionPixelOffset(R.dimen.hud_joy_margin), bottomBarBg.getHeight() + margin, 0);

		btnCombinedYawOff = new Button(res, R.drawable.btn_sphero2, R.drawable.btn_sphero2, Align.BOTTOM_RIGHT);    
		btnCombinedYawOff.setMargin(0, res.getDimensionPixelOffset(R.dimen.hud_joy_margin), bottomBarBg.getHeight() + margin, 0);
...
//	public void setPrimarySpheroData(int sph_pitch, int sph_roll, float pitch, float roll){
//		txtSphPitch.setText("sphero 1 - pitch : " + sph_pitch);
//		txtSphRoll.setText("sphero 1 - roll : " + sph_roll);
//		txtDronePitch.setText("drone - pitch : " + pitch);
//		txtDroneRoll.setText("pitch - roll : " + roll);
//	}
//	
//	public void setSecondarySpheroData(int sph_pitch, int sph_roll, float gaz, float yaw){
//		txtSph2Pitch.setText("sphero 2 - pitch : " + sph_pitch);
//		txtSph2Roll.setText("sphero 2 - roll : " + sph_roll);
//		txtDroneGaz.setText("drone - gaz : " + gaz);
//		txtDroneYaw.setText("drone - yaw : " + yaw);
//	}
	...
	public void setCombinedYawOnVisible(boolean value) {
		this.btnCombinedYawOn.setVisible(value);
	}
	
	public void setCombinedYawOffVisible(boolean value) {
		this.btnCombinedYawOff.setVisible(value);
	}
	...
	public void setBtnCombinedYawOnClickListener(OnClickListener listener)
	{
		this.btnCombinedYawOn.setOnClickListener(listener);
	}
	
	public void setBtnCombinedYawOffClickListener(OnClickListener listener)
	{
		this.btnCombinedYawOff.setOnClickListener(listener);
	}
